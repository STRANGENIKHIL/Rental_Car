// Car Card Component
// Displays summary information for a single car item, including image, price per day, specs (seats, fuel type, transmission, location), and availability badge.
import { useNavigate } from 'react-router-dom';
import { assets } from '../assets/assets';

const CarCard = ({car}) => {
    // Get configured currency symbol or fall back to '$'
  ...
  return (
    <div  onClick={()=>{navigate(`/car-details/${car._id}`) ; scrollTo(0,0)}}className='group rounded-xl overflow-hidden shadow-lg hover:-translate-y-1 transition-all duration-500 cursor-pointer'>
        ...
        {/* Car Image and Overlay Badges/Price */}
        <div className='relative h-48 overflow-hidden'>
            ...
            {/* Display "Available Now" badge if the car is currently available */}
