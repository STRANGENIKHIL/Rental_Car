...
const CarDetails = () => {
  ...
  return (
    <div className='px-6 md:px-16 lg:px-24 xl:px-32 my-12 min-h-screen'>
      <button 
        onClick={() => navigate(-1)} 
        className="flex items-center gap-2 mb-6 text-gray-500 hover:text-primary transition-colors cursor-pointer group"
      >
        <img src={assets.arrow_icon} alt="" className="rotate-180 opacity-65 group-hover:opacity-100 group-hover:-translate-x-1 transition-all"/>
        Back to all cars
      </button>
